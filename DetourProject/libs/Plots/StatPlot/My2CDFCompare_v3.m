function p = My2CDFCompare_v3(d,ax,colors,ldgstr,lgdfont,tail)
...
% plot sigbar
plot(ax,[xl(2)*(xstart-0.01)+xl(1)*(1.01-xstart) xl(2)*(xstart-0.01)+xl(1)*(1.01-xstart)],[y1 y2],'-k')
text(ax,xl(2)*(xstart-0.02)+xl(1)*(1.02-xstart),mean([y1,y2]),sigstr,'HorizontalAlignment','right','FontSize',lgdfont)
