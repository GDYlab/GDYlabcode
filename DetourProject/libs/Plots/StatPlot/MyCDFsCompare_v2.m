function MyCDFsCompare_v2(d,ax,ldgstr,varargin)
...
args.lgdfont = 10; % legend font size
args.tail = 'unequal'; % ks test tail
args.ppairs = []; % ks test pairs, 2*n with column being pair to compare
args.lgdpos = 'se'; % legend put at south-east or 'nw'
args.xlim = [];
