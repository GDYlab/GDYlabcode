function pout=myBinomTest_yc(s,n,p,Sided)
...
%               if 'oneright', get the probability that s is greater than
%               chance level p
%               if 'oneleft', get the probability that s is smaller than
%               chance level p
% Outputs:
