...
cd(GenPath{1})
load SleepReplaysTimeCellsHPCConcat
Sleep1=ReplaySleep;
time1=Sleep1.t;
sig1=Sleep1.pdf;
clear Sleep1 
...
if ii < 11 ; nnn1=[2,3,5]; nnn2=[1,4,6];
else nnn1=[1,4,6]; nnn2=[2,3,5]; end
...
x2=nanmean(nanmean(squeeze(Decoded1(1,nnn2,:))'));
Probability1{1,nn1}{gg,rr}(cc,:)=[x1,x2];
end
end
  toc
 end
...
GenPath=strcat(paths1{2},'Results/PlotFigures/Database');
cd(GenPath)
save('GoalProbLearnEffectOnSleepFramesHPCNewVsOldRipp.mat','Probability1')
...
GenPath=strcat(paths,Replayfile{ii});
cd(GenPath{1})
load SleepReplaysTimeCellsPFCConcat
Sleep1=ReplaySleep;
time1=Sleep1.t;
sig1=Sleep1.pdf;
clear Sleep1 
...
GenPath=strcat(paths1{2},'Results/PlotFigures/Database');
cd(GenPath)
save('GoalProbLearnEffectOnSleepFramesHPCNewVsOldRippPFC.mat','Probability1')
...
DecodedFrames1=sig1{1, aa}{1, jj}(ind);
...
GenPath=strcat(paths1{2},'Results/PlotFigures/Database');
cd(GenPath)
save('GoalProbLearnEffectOnSleepFramesHPCNewVsOld.mat','Probability1')
...
GenPath=strcat(paths1{2},'Results/PlotFigures/Database');
cd(GenPath)
save('GoalProbLearnEffectOnSleepFramesPFCNewVsOld.mat','Probability1')
